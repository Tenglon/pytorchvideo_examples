...
from clean_video_after_feat import clean

# CUDA_VISIBLE_DEVICES=0 &&  python clean_video_after_feat.py && python yk400_feat.py
...
class ARGS():
    def __init__(self):
        ...
        self.ch                         = 'r'
        self.data_dir                   = f'/local/tlong/{self.ch}k400'
...
def main():
    ...
    for batch in tqdm(feat_train_loader):
        ...
        if len(exist_samples_in_batch) == len(batch_label):
